#ifndef TTF_ROBOTO_REGULAR_H
#define TTF_ROBOTO_REGULAR_H

unsigned char ttf_roboto_regular[] = {
...
unsigned int ttf_roboto_regular_len = 145348;

#endif /* TTF_ROBOTO_REGULAR_H */
