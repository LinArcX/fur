...
#pragma warning(                                                               \
  disable : 4201) // nonstandard extension used : nameless struct/union
    ...
    // Creates and returns an image patter. Parameters (ox,oy) specify the
    ...
    struct NVGparams
    {
        ...
        int (*renderCreateTexture)(void *uptr,
                                   int type,
                                   int w,
                                   int h,
                                   int imageFlags,
        ...
        int (*renderUpdateTexture)(void *uptr,
                                   int image,
                                   int x,
                                   int y,
                                   int w,
